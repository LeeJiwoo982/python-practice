...
print(f'x의 id: {id(x)}') # 1744658191360
print(f'y의 id: {id(y)}') # 1744658191360
print(f'z의 id: {id(z)}') # 1744658474752
...
# 다차원 리스트
# 2차원 리스트와 같이 변경가능 안에 변경가능객체가 있는 경우
print('\n다차원 리스트 얕은 복사의 한계')
a = [1, 2, [3, 4, 5]]
b = a[:]
...
b[2][1] = 100
print(a)  #[1, 2, [3, 100, 5]]  b만 고쳤는데 a도 2차원 안은 변경
